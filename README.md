...
The core of this stage is the LM358 operational amplifier, configured as a unity-gain differential amplifier.
...
The inputs of the OA ensure virtually no current is drawn from the test loop, maintaining the integrity of the selected test current.
